  ...
  (0, _qunit.module)('Integration | Component | list-filter', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "pPX8n6DT",
        "block": "{\"symbols\":[],\"statements\":[[1,[20,\"list-filter\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('super-rentals/tests/integration/helpers/rental-property-type-test', ['exports'], function (exports) {
    'use strict';
